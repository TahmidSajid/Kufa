...
@section('main')
        ...
        <main>
            ...
            <section id="home" class="banner-area banner-bg fix">
                            ...
                            <div class="banner-content">
                                ...
                                <div class="banner-social wow fadeInUp" data-wow-delay="0.8s">
                                    <ul>
                                        ...
                                        <li><a href="{{ $social->social_media_link }}"><i class="{{ $social->social_media_icon }}"></i></a></li>
                                        @endforeach
                                    </ul>
                                </div>
                ...
                <div class="banner-shape"><img src="{{ asset('frontend-aasets') }}/img/shape/dot_circle.png" class="rotateme" alt="img"></div>
            </section>
            <!-- banner-area-end -->
            @endforeach
            ...
            <section id="about" class="about-area primary-bg pt-120 pb-120">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="about-img">
                                <img src="{{ asset('frontend-aasets') }}/img/banner/banner_img2.png" title="me-01" alt="me-01">
                            </div>
                        </div>
                            ...
                            <div class="education">
                                ...
                                <div class="location">
                                    ...
                                    <div class="progressWrapper">
                                        <div class="progress">
                                            <div class="progress-bar wow slideInLefts" data-wow-delay="0.2s" data-wow-duration="2s" role="progressbar" style="width: {{ $edu->skill }}%;" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 pitem">
                            <div class="speaker-box">
								...
								<div class="speaker-overlay">
									...
									<a href="{{ route('portfolio_page',$port->id) }}" class="arrow-btn">More information <span></span></a>
								</div>
							</div>
                        </div>
                        @endforeach
                            ...
                            <div class="testimonial-active">
                                <div class="single-testimonial text-center">
                                    <div class="testi-avatar">
                                        <img src="{{ asset('uploads/customer_images') }}/{{ $testi->customer_image }}" alt="img" >
                                    </div>
